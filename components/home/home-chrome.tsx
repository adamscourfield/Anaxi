  ...
  return (
    <div className="flex min-w-0 flex-wrap items-start justify-between gap-3">
      <div className="flex min-w-0 items-center gap-3.5">
        {icon ? (
          <span
            className={`inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-sm shadow-none [&_svg]:h-[1.125rem] [&_svg]:w-[1.125rem] ${tile}`}
          >
            {icon}
          </span>
        ) : null}
...
/** Open book — attainment KPI tiles */
...
/** Two people silhouette — students assessed */
...
/** Outline flag — dual-flagged KPI */
export function IconFlagOutline({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden>
      <path d="M4 22V4a1 1 0 0 1 1-1h14l-3 5 3 5H8" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
