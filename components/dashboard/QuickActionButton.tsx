  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="inline-flex items-center gap-2 rounded-md bg-[var(--primary)] px-5 py-2.5 text-sm font-semibold text-on-primary calm-transition anx-card-elevated hover:bg-primaryBtnHover hover:shadow-md active:scale-[0.98]"
      >
