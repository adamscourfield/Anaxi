      ...
      <div className="grid grid-cols-1 gap-0 lg:grid-cols-[1fr_min(100%,380px)]">
        ...
        <div className="space-y-5 p-6 sm:p-8 lg:border-r lg:border-[color-mix(in_srgb,var(--outline-variant)_18%,transparent)]">
          ...
          >
            {fileName ? (
              <>
                <div className="mb-2 flex h-12 w-12 items-center justify-center rounded-md bg-[var(--pill-success-bg)] text-[var(--success)]">
              ...
              <>
                ...
                <button
                  ...
                  className="mt-4 rounded-md border border-[color-mix(in_srgb,var(--outline-variant)_40%,transparent)] bg-[var(--surface-container-lowest)] px-6 py-2.5 text-sm font-semibold text-text shadow-sm transition-colors hover:bg-[var(--surface-container-low)]"
                >
                  Browse Files
                </button>
              </>
        ...
        <div className="flex flex-col gap-5 bg-[color-mix(in_srgb,var(--surface-container-low)_35%,var(--surface-container-lowest))] p-6 sm:p-8">
          ...
          <div className="rounded-2xl border border-[color-mix(in_srgb,var(--pill-info-ring)_35%,transparent)] bg-[color-mix(in_srgb,var(--pill-info-bg)_55%,var(--surface-container-lowest))] p-5">
            <div className="mb-2 flex items-center gap-2">
              <div className="flex h-5 w-5 items-center justify-center rounded-md bg-[var(--pill-info-bg)] text-[var(--pill-info-text)]">
          ...
          <div className="mt-auto">
            <Button
              ...
              className="w-full gap-2 rounded-md py-3.5 text-base font-semibold shadow-md"
            >
