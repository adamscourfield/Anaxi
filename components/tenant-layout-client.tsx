  ...
  return (
    <>
      ...
      <div
        ...
        id="tenant-content"
      >
        <header className="sticky top-0 z-20 flex h-14 shrink-0 items-center gap-3 px-4 glass-surface sm:px-6 lg:px-10">
          <button
            type="button"
            className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[0.75rem] text-[var(--on-surface)] calm-transition hover:bg-[var(--surface-container-low)] md:hidden"
          ...
          <Link
            href="/profile"
            className="flex shrink-0 items-center gap-2 rounded-[0.75rem] px-2 py-1.5 calm-transition hover:bg-[var(--surface-container-low)] sm:gap-3 sm:px-2.5 sm:py-1.5"
          >
        ...
        <main className="min-w-0 flex-1 px-4 py-6 sm:px-6 md:px-8 md:py-8 lg:px-10">
          <div key={pathname} className="mx-auto min-w-0 max-w-[1400px] motion-reduce:animate-none motion-safe:animate-page-enter">
            {children}
          </div>
        </main>
      </div>
