        ...
        <form onSubmit={handleSubmit} className="flex flex-1 flex-col overflow-hidden">
          ...
          <div className="flex items-center justify-between gap-3 border-t border-border/20 px-6 py-4">
            ...
            <button
              type="submit"
              disabled={pending}
              className="inline-flex items-center justify-center rounded-xl bg-neutral-950 px-6 py-2.5 text-[0.8125rem] font-semibold text-white shadow-sm calm-transition hover:bg-neutral-900 disabled:opacity-50 dark:bg-white dark:text-neutral-950"
            >
